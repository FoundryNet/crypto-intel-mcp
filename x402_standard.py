...
SERVER_NAME = 'Crypto Market Intelligence MCP'
SERVER_DESC = 'Query crypto prices and market sentiment — free price and market overview, plus paid history, DeFi TVL, volume-derived whale flows and anomaly scans from CoinGecko + DeFiLlama.'

# (tool, price-const-in-config | None, literal-fallback, human description)
_PAID = [
    ["brief_summary", "PRICE_BRIEF_SUMMARY", 0.5, "Brief summary — top 5 signals (sample of daily_brief)"],['price_history', 'PRICE_PRICE_HISTORY', 0.01, 'Price history'], ['whale_alerts', 'PRICE_WHALE_ALERTS', 0.01, 'Whale alerts'], ['defi_overview', 'PRICE_DEFI_OVERVIEW', 0.01, 'Defi overview'], ['anomaly_scan', 'PRICE_ANOMALY_SCAN', 0.02, 'Anomaly scan'], ['token_risk_scan', 'PRICE_TOKEN_RISK', 0.02, 'DeFi/token risk score — market cap, liquidity, volatility, sentiment'], ['daily_brief', 'PRICE_DAILY_BRIEF', 15.0, 'Daily brief']]
